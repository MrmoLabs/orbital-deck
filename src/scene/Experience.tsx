...
export function Experience(props: ExperienceProps) {
    ...
    return (
        ...
        >
            {/* Per-theme gradient sky (replaces the flat black clear color). */}
            <SceneBackground theme={props.theme} />

            {/* Lighting rig: warm key (sun), cold fill, theme-colored rim. */}
            ...
            <directionalLight position={[-30, 35, -70]} intensity={0.4} color={props.theme.accent} />

            {/* Per-theme backdrop — not hardwired to a starfield. */}
            <Backdrop kind={props.theme.backdrop} accent={props.theme.accent} />
...
function SceneContent({ theme, model, focus, wireframe, autoRotate, onPick }: ExperienceProps) {
